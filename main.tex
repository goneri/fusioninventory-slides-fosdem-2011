...
\begin{frame}
 ...
 \end{column}
 \begin{column}{0.45\textwidth}
    \begin{block}{Both inventory and helpdesk}
        \begin{itemize}
            \item Inventory assets, contracts, suppliers, ...
            \item Tickets from users, monitoring systems, ... 
            \item Get accurate statistics !
        \end{itemize}
